...
const hrTranslations = {
  ...
  badge__requiresAction: 'Zahtjeva akciju',
  ...
  formButtonPrimary__verify: 'Verificiraj',
  formFieldAction__forgotPassword: 'Zaboravljena zaporka?',
  formFieldError__matchingPasswords: 'Zaporke se poklapaju.',
  formFieldError__notMatchingPasswords: 'Zaporke se ne poklapaju.',
  ...
  formFieldLabel__confirmPassword: 'Potvrdi zaporku',
  formFieldLabel__currentPassword: 'Trenutna zaporka',
  ...
  formFieldLabel__newPassword: 'Nova zaporka',
  formFieldLabel__organizationDomain: 'Domena',
  formFieldLabel__organizationDomainDeletePending: 'Obriši čekajuće pozivnice i prijedloge',
  formFieldLabel__organizationDomainEmailAddress: 'E-mail adresa za verifikaciju',
  formFieldLabel__organizationDomainEmailAddressDescription:
    'Unesite e-mail adresu pod ovom domenom da biste primili kod i verificirali ovu domenu.',
  formFieldLabel__organizationName: 'Naziv',
  formFieldLabel__organizationSlug: 'Slug',
  formFieldLabel__passkeyName: 'Naziv ključa za prolaz',
  formFieldLabel__password: 'Zaporka',
  ...
  organizationProfile: {
    ...
    createDomainPage: {
      subtitle:
        'Dodajte domenu za verifikaciju. Korisnici sa e-mail adresama na ovom domenu mogu se automatski pridružiti organizaciji ili zatražiti pridruživanje.',
      title: 'Dodaj domen',
    },
    invitePage: {
      detailsTitle__inviteFailed:
        'Pozivnice nisu poslane. Već postoje čekajuće pozivnice za sljedeće e-mail adrese: {{email_addresses}}.',
      formButtonPrimary__continue: 'Pošalji pozivnice',
      selectDropdown__role: 'Izaberi ulogu',
      subtitle: 'Unesi ili naljepi jednu ili više e-mail adresa, razdvojene razmacima ili zarezima.',
      successMessage: 'Pozivnice su uspješno poslane',
    ...
    membersPage: {
      ...
      invitationsTab: {
        autoInvitations: {
          headerSubtitle:
            'Pozovi korisnike povezivanjem e-mail domena sa vašom organizacijom. Svatko tko se registruje sa odgovarajućim e-mail domenom može se pridružiti organizaciji u bilo koje vrijeme.',
      ...
      requestsTab: {
        autoSuggestions: {
          headerSubtitle:
            'Korisnici koji se registriraju sa odgovarajućim e-mail domenom, moći će da vide prijedlog da zatraže pridruživanje vašoj organizaciji.',
    ...
    profilePage: {
      dangerSection: {
        ...
        leaveOrganization: {
          actionDescription: 'Upiši "{{organizationName}}" ispod da nastaviš.',
          messageLine1:
            'Da li ste sigurni da želite napustiti ovu organizaciju? Izgubit ćete pristup ovoj organizaciji i njenim aplikacijama.',
          messageLine2: 'Ova akcija je trajna i nepovratna.',
    ...
    removeDomainPage: {
      messageLine1: 'E-mail domen {{domain}} biti će uklonjen.',
    ...
    verifiedDomainPage: {
      dangerTab: {
        calloutInfoLabel: 'Uklanjanje ove domene će utjecati na pozvane korisnike.',
        removeDomainActionLabel__remove: 'Ukloni domenu',
        removeDomainSubtitle: 'Ukloni ovu domenu iz tvojih potvrđenih domena',
        removeDomainTitle: 'Ukloni domenu',
      },
      enrollmentTab: {
        automaticInvitationOption__description:
          'Korisnici se automatski pozivaju da se pridruže organizaciji kada se registriraju i mogu se pridružiti u bilo koje vrijeme.',
        automaticInvitationOption__label: 'Automatske pozivnice',
        automaticSuggestionOption__description:
          'Korisnici dobijaju prijedlog da zatraže pridruživanje, ali moraju biti odobreni od strane administratora prije nego što mogu da se pridruže organizaciji.',
        automaticSuggestionOption__label: 'Automatski prijedlozi',
        calloutInfoLabel: 'Promjena načina upisa će utjecati samo na nove korisnike.',
        calloutInvitationCountLabel: 'Čekajuće pozivnice poslane korisnicima: {{count}}',
        calloutSuggestionCountLabel: 'Čekajući prijedlozi poslani korisnicima: {{count}}',
    ...
    verifyDomainPage: {
      formSubtitle: 'Unesi verifikacijski kod poslan na tvoju e-mail adresu',
      formTitle: 'Verifikacijski kod',
      resendButton: 'Nisi primio kod? Pošalji ponovo',
      subtitle: 'Domena {{domainName}} mora biti verifikovana putem e-maila.',
      subtitleVerificationCodeScreen: 'Verifikacijski kod je poslan na {{emailAddress}}. Unesi kod da nastaviš.',
      title: 'Verificiraj domenu',
    },
  },
  organizationSwitcher: {
    ...
    personalWorkspace: 'Osobninalog',
    suggestionsAcceptedLabel: 'Čeka odobrenje',
  },
  paginationButton__next: 'Sljedeći',
  ...
  signIn: {
    ...
    alternativeMethods: {
      ...
      blockButton__password: 'Prijavi se sa svojom zaporkom',
      ...
      getHelp: {
        ...
        content:
          'Ako imaš problema sa prijavljivanjem na svoj nalog, pošalji nam e-mail i pomoći ćemo ti da što prije povratiš pristup.',
        title: 'Zatraži pomoć',
      },
    ...
    backupCodeMfa: {
      subtitle: 'Tvoj rezervni kod je onaj koji si dobio kada si postavio dvostupanjsku autentifikaciju.',
    ...
    emailCode: {
      ...
      title: 'Provjeri svoj e-mail',
    },
    emailLink: {
      expired: {
        subtitle: 'Vrati se na originalni tab da nastaviš.',
        title: 'Ovaj verifikacijski link je istekao',
      },
      failed: {
        subtitle: 'Vrati se na originalni tab da nastaviš.',
        title: 'Ovaj verifikacijski link je nevažeći',
      },
      formSubtitle: 'Koristi verifikacijski link poslan na tvoj e-mail',
      formTitle: 'Verifikacijski link',
      loading: {
        subtitle: 'Uskoro ćeš biti preusmjeren',
    ...
    forgotPassword: {
      formTitle: 'Kod za resetovanje zaporke',
      resendButton: 'Nisi primio kod? Pošalji ponovo',
      subtitle: 'da resetuješ svoju zaporku',
      subtitle_email: 'Prvo, unesi kod poslan na tvoju e-mail adresu',
      subtitle_phone: 'Prvo, unesi kod poslan na tvoj telefon',
      title: 'Resetuj lzaporku',
    },
    forgotPasswordAlternativeMethods: {
      blockButton__resetPassword: 'Resetuj svoju zaporku',
    ...
    passkey: {
      subtitle:
        'Korišćenje tvojeg ključa za prolaz potvrđuje da si to ti. Tvoj uređaj može zatražiti otisak prsta, lice ili zaslon zaključavanja.',
      title: 'Koristi svoj ključ za prolaz',
    },
    password: {
      actionLink: 'Koristi drugu metodu',
      subtitle: 'Unesi zaporku koja je povezana sa tvojim nalogom',
      title: 'Unesi svoju zaporku',
    },
    passwordPwned: {
      title: 'Zaporka kompromitovana',
    },
    phoneCode: {
      formTitle: 'Verifikacijski kod',
      resendButton: 'Nisi primio kod? Pošalji ponovo',
      subtitle: 'da nastaviš na {{applicationName}}',
      title: 'Provjeri svoj telefon',
    },
    phoneCodeMfa: {
      formTitle: 'Verifikacijski kod',
      resendButton: 'Nisi primio kod? Pošalji ponovo',
      subtitle: 'Da nastaviš, molimo unesi verifikacijski kod poslan na tvoj telefon',
      title: 'Provjeri svoj telefon',
    },
    resetPassword: {
