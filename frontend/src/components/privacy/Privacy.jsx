...
const Privacy = () => {
  return (
    ...
    <h2 className='flex items-center justify-center text-accent font-bold uppercase text-2xl my-8'>
     ...
     <p className='mt-2'>
     Prilikom stvaranja korisničkog računa na www.zivic-elektro.com od vas se traže pojedini osobni podaci, uključujući  ime (naziv), adresu,OIB, adresu e-pošte. Adresa e-pošte i lozinka se koristi za prijavu na portal. Vaš je račun na www.zivic-elektro.com zaštićen je korisničkim imenom i lozinkom. Korisničko ime i lozinku sustav koristi kako bi provjerio jeste li Vi zaista pretplatnik ili korisnik portala.
     </p>
     <p className='mt-2'>
     ...
     <p className='mt-2'>
     Sukladno čl. 10. Zakona o zaštiti potrošača, potrošači mogu uložiti pisani prigovor putem elektronske pošte.
     </p>
     <p className='mt-2'>
     ...
     <p className='mt-2'>
     Vašem računu možemo pristupiti kako bi nam pomogao da vam pružimo potrebnu pomoć
     </p>
     <p className='mt-2'>
     ...
     <p className='mt-2'>
     www.zivic-elektro.hr sadrži dio gdje možete ostaviti komentare pomoću kojeg možete objavljivati informacije i poruke. Imajte na umu kako sve informacije koje na našem web-mjestu objavite kroz takve usluge ili na drugi način mogu postati javne informacije i mogu biti dostupne posjetiteljima web-mjesta i široj javnosti. Potičemo vas na oprez i diskreciju prilikom objavljivanja osobnih podataka ili drugih informacija na našem web-mjestu.
     </p>
     <p className='mt-2'>
